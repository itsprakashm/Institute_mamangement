...
@section('content')
  ...
  <div class="">
    ...
    <div class="">
      ...
      <a href="{{ url('/hrm/employee-list') }}" class="text-secondary-light hover-text-primary hover-underline "> /
        HRM</a>
      <span class="text-secondary-light">/ Employee List</span>
    </div>
  </div>
  <a href="{{ url('/students/add') }}" class="btn btn-primary-600 d-flex align-items-center gap-6 ">
                        ...
                        <table class="table bordered-table mb-0 data-table" id="dataTable" data-page-length='10'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/teacher-avatar-img3.png') }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/teacher-avatar-img4.png') }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/teacher-avatar-img5.png') }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/teacher-avatar-img6.png') }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/teacher-avatar-img7.png') }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/teacher-avatar-img8.png') }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/teacher-avatar-img9.png') }}"
