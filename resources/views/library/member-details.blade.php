...
@section('content')
  ...
  <div class="">
    ...
    <div class="">
      ...
      <a href="{{ url('/library/books') }}" class="text-secondary-light hover-text-primary hover-underline "> /
        Library</a>
                    ...
                    <div class="d-flex gap-32 flex-md-row flex-column">
                        <div class="max-w-300-px w-100 text-center">
                            <figure class="mb-20 w-120-px h-120-px mx-auto rounded-circle overflow-hidden">
                                <img src="{{ asset('assets/images/thumbs/student-details-img.png') }}" alt="Student Image"
