                                                ...
                                                <li>
                                                    <form action="{{ route('courses.destroy', $course->id) }}" method="POST" class="d-inline">
                                                        ...
                                                        <button
                                                            ...
                                                            type="submit" onclick="return confirm('Are you sure you want to delete this class?')">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('courses.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control" required placeholder="e.g. B.COM PART1, JAC+1">
                            </div>
                            <div class="mb-3">
...
<script>
    ...
    $('.edit-btn').on('click', function() {
        ...
        const formAction = `{{ route('courses.update', '') }}/${id}`;
