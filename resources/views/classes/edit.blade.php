...
<form action="{{ route('classes.update', $class->id) }}" method="POST" class="mt-24">
    @csrf
    @method('PUT')
                    ...
                    <div class="row gy-3">
                        <div class="col-xxl-6 col-md-6">
                            <div class="">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $class->name) }}" placeholder="Enter Class Name" required>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-12 col-md-12">
                            <div class="">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="4" placeholder="Enter Class Description">{{ old('description', $class->description) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
