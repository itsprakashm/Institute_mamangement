                                                ...
                                                <li>
                                                    <form action="{{ route('sections.destroy', $section->id) }}" method="POST" class="d-inline">
                                                        ...
                                                        <button
                                                            ...
                                                            type="submit" onclick="return confirm('Are you sure you want to delete this section?')">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('sections.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control" required placeholder="e.g. A, B, Morning, Evening">
                            </div>
...
<script>
    ...
    $('.edit-btn').on('click', function() {
        ...
        const formAction = `{{ route('sections.update', '') }}/${id}`;
