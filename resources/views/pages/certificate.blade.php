                        ...
                        <table class="table bordered-table mb-0 data-table" id="dataTable" data-page-length='10'>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center flex-grow-1">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img1.png') }}" alt="Marvin McKinney"
                                    ...
                                    <td><img src="{{ asset('assets/images/thumbs/background-img.png') }}" alt="Image"></td>
                                    <td>
                                        <div class="btn-group">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center flex-grow-1">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img2.png') }}" alt="Kathryn Murphy"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center flex-grow-1">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img3.png') }}" alt="Devon Lane"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center flex-grow-1">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img4.png') }}" alt="Cody Fisher"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center flex-grow-1">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img5.png') }}" alt="Theresa Webb"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center flex-grow-1">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img6.png') }}" alt="Darrell Steward"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center flex-grow-1">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img7.png') }}" alt="Leslie Alexander"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center flex-grow-1">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img8.png') }}" alt="Guy Hawkins"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center flex-grow-1">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img9.png') }}" alt="Brooklyn Simmons"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center flex-grow-1">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img10.png') }}" alt="Kristin Watson"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
