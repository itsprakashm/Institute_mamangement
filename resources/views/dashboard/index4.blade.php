...
@section('content')
  ...
  <div class="">
    ...
    <p class="text-neutral-600 mt-4 mb-0">Parent â Track student progress, attendance, and academic performance in one place.</p>
  </div>
</div>
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <span
                                        ...
                                        <img src="{{ asset('assets/images/icons/parent-widget-icon1.png') }}" alt="Wallet Icon">
                                    </span>
                                    <div>
                                        ...
                                        <div class="ps-20 pt-20 pb-20">
                                            <div
                                                ...
                                                <div class="d-flex align-items-start gap-16">
                                                    <img src="{{ asset('assets/images/thumbs/notice-board-img1.png') }}"
                                                        alt="Thumbnail"
                                                ...
                                                <div class="d-flex align-items-start gap-16">
                                                    <img src="{{ asset('assets/images/thumbs/notice-board-img2.png') }}"
                                                        alt="Thumbnail"
                                                        class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0">
                                                    <div class="">
                                                ...
                                                <div class="d-flex align-items-start gap-16">
                                                    <img src="{{ asset('assets/images/thumbs/notice-board-img3.png') }}"
                                                        alt="Thumbnail"
                                                        class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0">
                                                    <div class="">
                                                        <h6 class="mb-4 text-lg">Admin</h6>
                                            ...
                                            <div class="p-20 bg-neutral-40 rounded">
                                                <div class="d-flex align-items-center gap-16">
                                                    <figure
                                                        ...
                                                        <img src="{{ asset('assets/images/thumbs/student-details-img.png') }}"
