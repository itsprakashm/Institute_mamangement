                    ...
                    <div class="card radius-12 border-0 h-100">
                        <div class="card-body p-24 d-flex gap-16 flex-sm-nowrap flex-wrap">
                            <div
                                ...
                                <img src="{{ asset('assets/images/bg/edit-profile-bg.png') }}" alt="BG Image"
                                    class="position-absolute start-0 top-0 w-100 h-100 z-n1">
                                <div class="">
                                    <span class="mb-12">
                                        <img src="{{ asset('assets/images/thumbs/studnt-edit-profile-img.png') }}" alt="BG Image"
                            ...
                            <div class="d-flex flex-column gap-20 flex-grow-1 justify-content-between">
                                <div
                                    ...
                                    <span
                                        ...
                                        <img src="{{ asset('assets/images/icons/teacher-widget-icon1.png') }}" alt="User Icon">
                                    </span>
                                    <div class="">
                                ...
                                <div
                                    ...
                                    <span
                                        ...
                                        <img src="{{ asset('assets/images/icons/teacher-widget-icon2.png') }}" alt="User Icon">
                                    </span>
                                    <div class="">
                                ...
                                <div
                                    ...
                                    <span
                                        ...
                                        <img src="{{ asset('assets/images/icons/teacher-widget-icon3.png') }}" alt="User Icon">
                                    </span>
                                    <div class="">
