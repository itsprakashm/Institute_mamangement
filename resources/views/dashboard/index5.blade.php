                                ...
                                <div class="border rounded-3">
                                    <div class="px-16 py-12 d-flex gap-8 align-items-center">
                                        <span
                                            ...
                                            <img src="{{ asset('assets/images/icons/lms-icon-1.png') }}" alt="Icon">
                                        </span>
                                        <span class="text-primary-light fw-medium">Enrolled Courses</span>
                                    </div>
                                    <div class="position-relative z-1">
                                        <img src="{{ asset('assets/images/icons/lms-card-gradient-bg1.png') }}"
                                ...
                                <div class="border rounded-3">
                                    <div class="px-16 py-12 d-flex gap-8 align-items-center">
                                        <span
                                            ...
                                            <img src="{{ asset('assets/images/icons/lms-icon-2.png') }}" alt="Icon">
                                        </span>
                                        <span class="text-primary-light fw-medium">Total Students</span>
                                    </div>
                                    <div class="position-relative z-1">
                                        <img src="{{ asset('assets/images/icons/lms-card-gradient-bg2.png') }}"
                                            class="position-absolute w-100 h-100 z-n1 object-fit-cover lms-card-gradient-bg"
                                            alt="Gradient BG">
                                        <div
                                            class="px-16 py-12 d-flex align-items-center justify-content-between gap-12 flex-wrap">
                                ...
                                <div class="border rounded-3">
                                    <div class="px-16 py-12 d-flex gap-8 align-items-center">
                                        <span
                                            ...
                                            <img src="{{ asset('assets/images/icons/lms-icon-3.png') }}" alt="Icon">
                                        </span>
                                        <span class="text-primary-light fw-medium">Total Courses</span>
                                    </div>
                                    <div class="position-relative z-1">
                                        <img src="{{ asset('assets/images/icons/lms-card-gradient-bg3.png') }}"
                                            class="position-absolute w-100 h-100 z-n1 object-fit-cover lms-card-gradient-bg"
                                            alt="Gradient BG">
                                        <div
                                            class="px-16 py-12 d-flex align-items-center justify-content-between gap-12 flex-wrap">
                                ...
                                <div class="border rounded-3">
                                    <div class="px-16 py-12 d-flex gap-8 align-items-center">
                                        <span
                                            ...
                                            <img src="{{ asset('assets/images/icons/lms-icon-4.png') }}" alt="Icon">
                                        </span>
                                        <span class="text-primary-light fw-medium">Total Earnings</span>
                                    </div>
                                    <div class="position-relative z-1">
                                        <img src="{{ asset('assets/images/icons/lms-card-gradient-bg4.png') }}"
                                            class="position-absolute w-100 h-100 z-n1 object-fit-cover lms-card-gradient-bg"
                                            alt="Gradient BG">
                                        <div
                                            class="px-16 py-12 d-flex align-items-center justify-content-between gap-12 flex-wrap">
                            ...
                            <div class="row g-3">
                                    ...
                                    <div class="border rounded-3 p-12">
                                        <div class="d-flex  gap-12">
                                            <div class="d-flex flex-shrink-0">
                                                <img src="{{ asset('assets/images/thumbs/session-img1.png') }}" alt="Image"
                                ...
                                <div class="col-sm-6">
                                    <div class="border rounded-3 p-12">
                                        <div class="d-flex  gap-12">
                                            <div class="d-flex flex-shrink-0">
                                                <img src="{{ asset('assets/images/thumbs/session-img2.png') }}" alt="Image"
                                                    class="w-100 h-100 object-fit-cover rounded-3">
                                            </div>
                                            <div class="align-self-center w-100">
