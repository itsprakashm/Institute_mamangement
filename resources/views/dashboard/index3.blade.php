                            ...
                            <div class="row g-3">
                                <div class="col-md-5">
                                    <div class="radius-8 overflow-hidden position-relative z-1 h-100 py-32 px-20 text-center d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/images/bg/edit-profile-bg.png') }}" alt="BG Image" class="position-absolute start-0 top-0 w-100 h-100 object-fit-cover z-n1">
                                        <div class="">
                                            <span class="mb-12">
                                                <img src="{{ asset('assets/images/thumbs/edit-profile-img.png') }}" alt="BG Image" class="rounded-circle object-fit-cover">
                                            </span>
                                            ...
                                            <div class="mt-12">
                                                <a href="{{ url('/teachers/edit') }}" class="px-20 py-8 text-white bg-white bg-opacity-10 radius-6 fw-medium text-lg">Edit Profile</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-6 col-xs-6">
                                            <div class="radius-8 py-24 px-16 text-center bg-danger-100">
                                                <span
                                                    ...
                                                    <img src="{{ asset('assets/images/icons/teacher-widget-icon4.png') }}"
                                                        alt="User Icon">
                                                </span>
                                                <span class="text-secondary-light fw-medium d-block mt-12">Total
                                                    Students</span>
                                ...
                                <table class="table bordered-table mb-0 data-table" id="dataTable"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="py-10-px">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/thumbs/avatar-img2.png') }}" alt="Image"
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-10-px">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/thumbs/avatar-img3.png') }}" alt="Image"
                                                        class="flex-shrink-0 me-12 radius-8">
                                                    <div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-10-px">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/thumbs/avatar-img4.png') }}" alt="Image"
                                                        class="flex-shrink-0 me-12 radius-8">
                                                    <div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-10-px">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/thumbs/avatar-img5.png') }}" alt="Image"
                                                        class="flex-shrink-0 me-12 radius-8">
                                                    <div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-10-px">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/thumbs/avatar-img6.png') }}" alt="Image"
                                                        class="flex-shrink-0 me-12 radius-8">
                                                    <div>
