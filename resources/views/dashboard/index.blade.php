                      ...
                      <div class="ps-20 pt-20 pb-20">
                        <div class="pe-20 d-flex flex-column gap-20 max-h-462-px overflow-y-auto scroll-sm">
                          <div class="d-flex align-items-start gap-16">
                            <img src="{{ asset('assets/images/thumbs/notice-board-img1.png') }}" alt="Thumbnail"
                          ...
                          <div class="d-flex align-items-start gap-16">
                            <img src="{{ asset('assets/images/thumbs/notice-board-img2.png') }}" alt="Thumbnail"
                              class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0">
                            <div class="">
                          ...
                          <div class="d-flex align-items-start gap-16">
                            <img src="{{ asset('assets/images/thumbs/notice-board-img3.png') }}" alt="Thumbnail"
                              class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0">
                            <div class="">
                              <h6 class="mb-4 text-lg">Admin</h6>
                              <p class="text-secondary-light text-sm mb-0">Lorem Ipsum is simply dummy text of the
                      ...
                      <div class="ps-20 pt-20 pb-20">
                        <div class="pe-20 d-flex flex-column gap-28 max-h-462-px overflow-y-auto scroll-sm">
                          <div class="d-flex align-items-center justify-content-between gap-16">
                            <div class="d-flex align-items-start gap-16">
                              <img src="{{ asset('assets/images/thumbs/leave-request-img1.png') }}" alt="Thumbnail"
                                class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0">
                              <div class="">
                          ...
                          <div class="d-flex align-items-center justify-content-between gap-16">
                            <div class="d-flex align-items-start gap-16">
                              <img src="{{ asset('assets/images/thumbs/leave-request-img3.png') }}" alt="Thumbnail"
                                class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0">
                              <div class="">
                          ...
                          <div class="d-flex align-items-center justify-content-between gap-16">
                            <div class="d-flex align-items-start gap-16">
                              <img src="{{ asset('assets/images/thumbs/leave-request-img4.png') }}" alt="Thumbnail"
                                class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0">
                              <div class="">
                          ...
                          <div class="d-flex align-items-center justify-content-between gap-16">
                            <div class="d-flex align-items-start gap-16">
                              <img src="{{ asset('assets/images/thumbs/leave-request-img5.png') }}" alt="Thumbnail"
                                class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0">
                              <div class="">
                ...
                <div>
                  <div class="mt-40 mb-24 pe-110 position-relative max-w-288-px mx-auto">
                    <div
                      ...
                      <img src="{{ asset('assets/images/icons/radial-bg1.png') }}" alt="Image"
                    ...
                    <div
                      ...
                      <img src="{{ asset('assets/images/icons/radial-bg2.png') }}" alt="Image"
                        class="position-absolute top-0 start-0 z-n1 w-100 h-100 object-fit-cover">
                    ...
                    <div
                      ...
                      <img src="{{ asset('assets/images/icons/radial-bg3.png') }}" alt="Image"
                        class="position-absolute top-0 start-0 z-n1 w-100 h-100 object-fit-cover">
            ...
            <div class="card-body p-0">
              ...
              <div class="ps-20 pt-20 pb-20">
                <div class="pe-20 d-flex flex-column gap-20 max-h-462-px overflow-y-auto scroll-sm">
                  <div class="d-flex align-items-center justify-content-between gap-16">
                    <div class="d-flex align-items-start gap-16">
                      <img src="{{ asset('assets/images/thumbs/top-teacher-img1.png') }}" alt="Thumbnail"
                        class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0">
                      <div class="">
                  ...
                  <div class="d-flex align-items-center justify-content-between gap-16">
                    <div class="d-flex align-items-start gap-16">
                      <img src="{{ asset('assets/images/thumbs/top-teacher-img2.png') }}" alt="Thumbnail"
                        class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0">
                      <div class="">
                  ...
                  <div class="d-flex align-items-center justify-content-between gap-16">
                    <div class="d-flex align-items-start gap-16">
                      <img src="{{ asset('assets/images/thumbs/top-teacher-img3.png') }}" alt="Thumbnail"
                        class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0">
                      <div class="">
                  ...
                  <div class="d-flex align-items-center justify-content-between gap-16">
                    <div class="d-flex align-items-start gap-16">
                      <img src="{{ asset('assets/images/thumbs/top-teacher-img4.png') }}" alt="Thumbnail"
                        class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0">
                      <div class="">
                  ...
                  <div class="d-flex align-items-center justify-content-between gap-16">
                    <div class="d-flex align-items-start gap-16">
                      <img src="{{ asset('assets/images/thumbs/top-teacher-img5.png') }}" alt="Thumbnail"
                        class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0">
                      <div class="">
            ...
            <div class="card-body">
              <div class="d-flex flex-column gap-28">
                ...
                <div class="d-flex align-items-center justify-content-between gap-10">
                  <div class="d-flex align-items-center gap-12">
                    <span class="w-44-px h-44-px rounded-circle d-flex justify-content-center align-items-center">
                      <img src="{{ asset('assets/images/thumbs/avatar-img2.png') }}"
                        class="w-44-px h-44-px object-fit-cover rounded-circle" alt="Icon">
                    </span>
                    <div class="">
                ...
                <div class="d-flex align-items-center justify-content-between gap-10">
                  <div class="d-flex align-items-center gap-12">
                    <span class="w-44-px h-44-px rounded-circle d-flex justify-content-center align-items-center">
                      <img src="{{ asset('assets/images/thumbs/avatar-img4.png') }}"
                        class="w-44-px h-44-px object-fit-cover rounded-circle" alt="Icon">
                    </span>
                    <div class="">
                ...
                <div class="d-flex align-items-center justify-content-between gap-10">
                  <div class="d-flex align-items-center gap-12">
                    <span class="w-44-px h-44-px rounded-circle d-flex justify-content-center align-items-center">
                      <img src="{{ asset('assets/images/thumbs/avatar-img5.png') }}"
                        class="w-44-px h-44-px object-fit-cover rounded-circle" alt="Icon">
                    </span>
                    <div class="">
