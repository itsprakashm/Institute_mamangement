...
@section('content')
  ...
  <a href="{{ url('/guardians/add') }}" class="btn btn-primary-600 d-flex align-items-center gap-6 ">
                        ...
                        <table class="table bordered-table mb-0 data-table" id="dataTable" data-page-length='10'>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/teacher-avatar-img1.png') }}"
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img1.png') }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/teacher-avatar-img2.png') }}"
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img2.png') }}" alt="Jane Cooper Image"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center"><img
                                                src="{{ asset('assets/images/thumbs/teacher-avatar-img3.png') }}" alt="Cody Fisher"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center"><img
                                                src="{{ asset('assets/images/thumbs/avatar-img3.png') }}" alt="Robert Fox"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center"><img
                                                src="{{ asset('assets/images/thumbs/teacher-avatar-img4.png') }}" alt="Jenny Wilson"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center"><img
                                                src="{{ asset('assets/images/thumbs/avatar-img4.png') }}" alt="Albert Flores"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center"><img
                                                src="{{ asset('assets/images/thumbs/teacher-avatar-img5.png') }}" alt="Theresa Webb"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center"><img
                                                src="{{ asset('assets/images/thumbs/avatar-img5.png') }}" alt="Leslie Alexander"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img2.png') }}" alt="Student Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium flex-grow-1 text-secondary-light">
                                                    Kathryn Murphy</h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/teacher-avatar-img3.png') }}" alt="Teacher Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium flex-grow-1 text-secondary-light">
                                                    Theresa Webb</h6>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img3.png') }}" alt="Student Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/teacher-avatar-img4.png') }}" alt="Teacher Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium flex-grow-1 text-secondary-light">
                                                    Courtney Henry</h6>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img4.png') }}" alt="Student Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium flex-grow-1 text-secondary-light">
                                                    Eleanor Pena</h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/teacher-avatar-img5.png') }}" alt="Teacher Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium flex-grow-1 text-secondary-light">
                                                    Albert Flores</h6>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img5.png') }}" alt="Student Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium flex-grow-1 text-secondary-light">
                                                    Jenny Wilson</h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/teacher-avatar-img6.png') }}" alt="Teacher Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium flex-grow-1 text-secondary-light">
                                                    Jerome Bell</h6>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img6.png') }}" alt="Student Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium flex-grow-1 text-secondary-light">
                                                    Esther Howard</h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/teacher-avatar-img7.png') }}" alt="Teacher Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium flex-grow-1 text-secondary-light">
                                                    Devon Lane</h6>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img7.png') }}" alt="Student Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium flex-grow-1 text-secondary-light">
                                                    Robert Fox</h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/teacher-avatar-img8.png') }}" alt="Teacher Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium flex-grow-1 text-secondary-light">
                                                    Floyd Miles</h6>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img8.png') }}" alt="Student Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                                <h6 class="text-md mb-0 fw-medium flex-grow-1 text-secondary-light">
                                                    Leslie Alexander</h6>
