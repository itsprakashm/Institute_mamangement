...
@section('content')
  ...
  <div class="">
    ...
    <div class="">
      ...
      <a href="{{ url('/guardians/list') }}" class="text-secondary-light hover-text-primary hover-underline d-none"> /
        guardian</a>
      <span class="text-secondary-light">/ Add New Guardian</span>
    </div>
  </div>
  <a href="{{ url('/guardians/add') }}" class="btn btn-primary-600 d-flex align-items-center gap-6 d-none">
