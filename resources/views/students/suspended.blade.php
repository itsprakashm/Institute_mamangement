                        ...
                        <table class="table bordered-table mb-0 data-table" id="dataTable" data-page-length='10'>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img1.png') }}" alt="Image"
                                    ...
                                    <td>General</td>
                                    <td> <span
                                            class="bg-danger-100 text-danger-600 px-24 py-4 radius-4 fw-medium text-sm">Suspend</span>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-lg-end border p-12">
                                                <li><button
                                                        class="dropdown-item rounded text-secondary-light bg-hover-neutral-200 text-hover-neutral-900 d-flex align-items-center gap-2 py-6"><i
                                                            class="ri-user-3-line"></i>View Teacher</button></li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img7.png') }}" alt="Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
