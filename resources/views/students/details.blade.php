        ...
        <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <div class="">
                ...
                <div class="">
                    ...
                    <a href="{{ url('/students/list') }}" class="text-secondary-light hover-text-primary hover-underline"> /
                        Student</a>
                    ...
                    <div class="d-flex gap-32 flex-md-row flex-column">
                        <div class="max-w-300-px w-100 text-center">
                            <figure class="mb-24 w-120-px h-120-px mx-auto rounded-circle overflow-hidden">
                                <img src="{{ asset('assets/images/thumbs/student-details-img.png') }}" alt="Student Image" class="w-100 h-100 object-fit-cover">
                            </figure>
                                                ...
                                                <div class="card-body p-0">
                                                    <div
                                                        ...
                                                        <span
                                                            ...
                                                            <img src="{{ asset('assets/images/icons/attendence-icon1.png') }}"
                                                                alt="Present Icon">
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card-body p-0">
                                                    <div
                                                        ...
                                                        <span
                                                            ...
                                                            <img src="{{ asset('assets/images/icons/attendence-icon2.png') }}"
                                                                alt="Absent Icon">
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card-body p-0">
                                                    <div
                                                        ...
                                                        <span
                                                            ...
                                                            <img src="{{ asset('assets/images/icons/attendence-icon3.png') }}"
                                                                alt="Calendar Icon">
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card-body p-0">
                                                    <div
                                                        ...
                                                        <span
                                                            ...
                                                            <img src="{{ asset('assets/images/icons/attendence-icon4.png') }}"
                                                                alt="Clock Icon">
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card-body p-0">
                                                    <div
                                                        ...
                                                        <span
                                                            ...
                                                            <img src="{{ asset('assets/images/icons/attendence-icon5.png') }}"
                                                                alt="Holiday Icon">
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div
                                                ...
                                                <div class="card-body p-0">
                                                    <div
                                                        ...
                                                        <span
                                                            class="mb-0 w-48-px h-48-px bg-info-600 text-white flex-shrink-0 text-white d-flex justify-content-center align-items-center rounded-circle h6 mb-0">
                                                            <img src="{{ asset('assets/images/icons/fees-icon1.png') }}"
                                                                alt="Clock Icon">
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div
                                                ...
                                                <div class="card-body p-0">
                                                    <div
                                                        ...
                                                        <span
                                                            class="mb-0 w-48-px h-48-px bg-danger-600 text-white flex-shrink-0 text-white d-flex justify-content-center align-items-center rounded-circle h6 mb-0">
                                                            <img src="{{ asset('assets/images/icons/fees-icon2.png') }}"
                                                                alt="Absent Icon">
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div
                                                ...
                                                <div class="card-body p-0">
                                                    <div
                                                        ...
                                                        <span
                                                            class="mb-0 w-48-px h-48-px bg-success-600 text-white flex-shrink-0 text-white d-flex justify-content-center align-items-center rounded-circle h6 mb-0">
                                                            <img src="{{ asset('assets/images/icons/fees-icon3.png') }}"
                                                                alt="Present Icon">
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div
                                                ...
                                                <div class="card-body p-0">
                                                    <div
                                                        ...
                                                        <span
                                                            class="mb-0 w-48-px h-48-px bg-orange text-white flex-shrink-0 text-white d-flex justify-content-center align-items-center rounded-circle h6 mb-0">
                                                            <img src="{{ asset('assets/images/icons/fees-icon4.png') }}"
                                                                alt="Holiday Icon">
                                                        </span>
                                                    </div>
                                                </div>
                                ...
                                <table class="table bordered-table mb-0 table-heading-dark-mode w-100 data-table"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-start">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/thumbs/library-img1.png') }}" alt="Library Image"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-start">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/thumbs/library-img2.png') }}" alt="Library Image"
                                                        class="flex-shrink-0 me-12 radius-4 w-36-px h-36-px">
                                                    <div class="">
                                                        <h6
                                                            class="text-md mb-0 fw-medium flex-grow-1 text-secondary-light">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-start">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/thumbs/library-img3.png') }}" alt="Library Image"
                                                        class="flex-shrink-0 me-12 radius-4 w-36-px h-36-px">
                                                    <div class="">
                                                        <h6
                                                            class="text-md mb-0 fw-medium flex-grow-1 text-secondary-light">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-start">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/thumbs/library-img4.png') }}" alt="Library Image"
                                                        class="flex-shrink-0 me-12 radius-4 w-36-px h-36-px">
                                                    <div class="">
                                                        <h6
                                                            class="text-md mb-0 fw-medium flex-grow-1 text-secondary-light">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-start">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/thumbs/library-img5.png') }}" alt="Library Image"
                                                        class="flex-shrink-0 me-12 radius-4 w-36-px h-36-px">
                                                    <div class="">
                                                        <h6
                                                            class="text-md mb-0 fw-medium flex-grow-1 text-secondary-light">
