...
<head>
  ...
  <meta name="description"
    content="Modern Education Admin Dashboard for schools, colleges, universities, and eLearning platforms. Includes student and course management, attendance, exams, payments, analytics, and a fully responsive clean UIâideal for LMS, coaching centers, and academic admin systems.">
  <meta name="keywords"
...
<div class="d-lg-flex bg-white">
    ...
    <div class="w-50 d-lg-block d-none overflow-hidden d-flex">
        <img src="{{ asset('assets/images/thumbs/login-img.png') }}" alt="Register Image" class="w-100 h-100 object-fit-cover">
    </div>
    ...
    <div class="lg-w-50 px-24 py-40 d-flex justify-content-center align-items-center">
        <div class="max-w-540-px mx-auto w-100">
            ...
            <div class="mt-48 mb-32">
                <h1 class="h6 fw-bold text-primary-light">Create Your Account ð</h1>
            ...
            <div class="mt-24 text-center text-sm">
                ...
                <a href="{{ url('/login') }}" class="text-primary-600 fw-semibold text-decoration-underline">
                    Log In
                </a>
            </div>
