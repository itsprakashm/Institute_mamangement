                        ...
                        <table class="table bordered-table mb-0 data-table" id="dataTable" data-page-length='10'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img8.png') }}" alt="Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img9.png') }}" alt="Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/thumbs/avatar-img10.png') }}" alt="Image"
                                                class="flex-shrink-0 me-12 radius-8">
                                            <div>
